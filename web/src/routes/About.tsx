  ...
  return (
    <article>
      ...
      <section className="prose-bh max-w-3xl">
        ...
        <p>This hub is the source-of-truth for how to use AI at BrookHaven, organized by three lenses:</p>
        <ul>
          <li><strong>By pain theme</strong> — the 8 themes that came out of the coworker survey</li>
          <li><strong>By role</strong> — what to try first if you're in a given position</li>
          <li><strong>By tool</strong> — how Claude works with each thing in the BrookHaven stack (Outlook, Telegram, Dropbox, Adobe PDF, Monday, Teams, QBO)</li>
        </ul>

        <h2>How tutorials are written</h2>
        <p>Every tutorial has the same shape so they're predictable to read:</p>
        <ul>
        ...
        <ul>
          <li><code>⌘K</code> or <code>Ctrl+K</code> — open command palette (search anything)</li>
          <li><code>/</code> — also opens the command palette</li>
          <li><code>Esc</code> — close the palette</li>
          <li><code>↑ ↓</code> — navigate results</li>
          <li><code>↵</code> — go to selected result</li>
        </ul>
        ...
        <p>
          ...
          touch client-facing output always include a propose-don't-act pattern.
        </p>

        <h2>What's coming next</h2>
        <ul>
          <li>
            <strong>Weekly newsletter</strong> — every Monday, a short digest of
            what's new in Claude / Claude Cowork / AI tooling, framed in terms
            of BrookHaven workflows. Delivered via email + Telegram channel + a 5–10
            min walkthrough at the Monday meeting.
          </li>
          <li>
            <strong>Per-role onboarding</strong> — when a new BrookHaven coworker joins,
            they'll get a personalized AI onboarding doc generated from their
            role + daily tasks.
          </li>
          <li>
        ...
        <p>Found a pitfall we should warn people about? Same channel.</p>
      </section>
