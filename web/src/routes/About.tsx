  ...
  return (
    <article>
      ...
      <section className="prose-bh max-w-3xl">
        ...
        <p>This hub is the source-of-truth for how to use AI at BH, organized by three lenses:</p>
        <ul>
          ...
          <li><strong>By tool</strong> — how Claude works with each thing in the BH stack (Outlook, Telegram, Dropbox, Adobe PDF, Monday, Teams, QBO)</li>
        </ul>
        ...
        <ul>
          <li>
            ...
            of BH workflows. Delivered via email + Telegram channel + a 5–10
            min walkthrough at the Monday meeting.
          </li>
          <li>
            <strong>Per-role onboarding</strong> — when a new BH coworker joins,
